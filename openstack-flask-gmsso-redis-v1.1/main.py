...
def create_openstack_resources(user):
    ...
    try:
        ...
        if admin_user and admin_role:
            ...
            print("⚠️ Warning: Default admin or admin role not found.")
        ...
        print(f"✅ OpenStack user & project created for {user.email}")

    except Exception as e:
        db.session.rollback()
        print(f"❌ Failed to create OpenStack resources: {e}")
        raise e
...
def google_logged_in(blueprint, token):
    ...
    if not user:
        ...
        # Create OpenStack resources after user is created
        try:
